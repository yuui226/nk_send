...
fun liquidProgressWaveEnvelope(progress: Float): Float {
...
fun liquidProgressWaveSeed(seedKey: Long?): Float {
...
fun liquidProgressWaveUnitOffset(
    normalizedY: Float,
    phaseTurns: Float,
    seedTurns: Float,
