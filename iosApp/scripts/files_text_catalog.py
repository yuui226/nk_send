...
EXTRA = {
 'english': ['Refresh', 'Queue', 'Shared preview is connected for Mac validation; the complete workspace and settings are still being connected.',
 ...
 'simplified': ['刷新', '队列', '共享预览已接入，待 Mac 验证；完整工作区和设置页仍在接线中。',
  '刷新失败，已保留原列表。', '部分元数据读取失败，已保留原列表。', '扫描期间相机目录有变化，请重新刷新；已保留原列表。',
  '目录结果无效，已保留原列表。', '未能加入这些文件，请查看队列后再重试。', '部分文件已加入，请查看队列后再重试。', '预览尚未就绪，请重新打开文件页重试。'],
 'traditional': ['重新整理', '佇列', '共用預覽已接入，待 Mac 驗證；完整工作區和設定頁仍在串接中。',
  '重新整理失敗，已保留原列表。', '部分中繼資料讀取失敗，已保留原列表。', '掃描期間相機目錄有變化，請重新整理；已保留原列表。',
  '目錄結果無效，已保留原列表。', '未能加入這些檔案，請查看佇列後再重試。', '部分檔案已加入，請查看佇列後再重試。', '預覽尚未就緒，請重新開啟檔案頁重試。'],
}
INDEX_FAILURE = {
