...
class PhotoViewportExtractionTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected = (extract_photo_preview_model(cls.expected[0])[0],) + cls.expected[1:]
    ...
    def test_android_uses_one_shared_viewport_for_full_and_single_previews(self):
        ...
        self.assertIn('SharedZoomablePreviewViewport(',android)
        ...
        for old,new in [('tween(240)','tween(241)'),('pressed >= 2','pressed >= 3'),
            ...
            with self.subTest(old=old):
                try:
                    ...
                    changed=(extract_photo_preview_model(changed[0])[0],)+changed[1:]
                except ValueError:
