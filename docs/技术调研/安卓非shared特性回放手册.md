...
|---|---|---|---|---|
| 1 | 三种连接协议结果保持一致 | `55876fa` | `NikonCamera`、对象元数据解析 | 已回放 |
...
| 4 | 入队飞行动画后的预览计数 | `16551ee` | `FileListScreen`、`PhotoPreview` | 已回放 |
...
当前状态：Android 已恢复到 `a6b679a`；已回放 9/9 个功能块；尚未构建或安装，等待统一真机回归。
